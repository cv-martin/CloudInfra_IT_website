          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h1 className="text-[clamp(2.5rem,6vw,4.5rem)] font-extrabold text-white leading-tight tracking-tighter">
                Engineering <br/><span className="text-white/40">Industrial Ops.</span>
              </h1>
              <p className="text-lg text-white/40 mt-6 max-w-lg leading-relaxed font-light">
                Domain-specialist recruiters placing Mechanical, Electrical, Structural, Process, and Systems Engineers across the USA.
              </p>
              ...
              <div className="mt-10 flex flex-wrap items-center gap-3">
                ...
                {["PE Licensed", "PMP Certified", "CWI Welding", "H-1B/TN Visa"].map(t => (
              ...
              <div className="mt-12 flex flex-col sm:flex-row gap-4">
                ...
                >
                  Browse Engineering Feed <ArrowRight className="h-4 w-4 ml-2 group-hover:translate-x-1 transition-all" />
                </Link>
                <Link
            ...
            >
              <Image
                ...
                alt="Engineering infrastructure visualization"
                fill
              ...
              <div className="absolute inset-x-8 bottom-8">
                 <div className="ci-card p-6 bg-black/40 backdrop-blur-xl border-white/10">
                    <p className="text-[10px] font-black uppercase tracking-[0.4em] text-[#a4f07a] mb-2">Industrial Status</p>
                    <p className="text-sm text-white/60 font-light">Credentialed sourcing active in 50 states. <br/>Primary clusters: Tier 1 & Tier 2 suppliers.</p>
                 </div>
              </div>
            </motion.div>
          </div>
      ...
      <main className="flex-1 bg-black">
        ...
        <section className="bg-black relative overflow-hidden text-white">
          ...
          <div className="ci-container py-24 relative z-10">
            <motion.div
              ...
              className="mb-16"
            >
              <span className="text-[10px] font-black uppercase tracking-[0.5em] text-[#a4f07a] mb-4 block">Industrial Disciplines</span>
              ...
              <p className="text-lg text-white/30 mt-6 max-w-2xl font-light leading-relaxed">
                From project management to SCADA implementation — we maintain a diverse, qualified engineering talent pool for USA engagements.
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
              ...
              >
                ...
                <p className="text-lg text-white/30 leading-relaxed font-light mb-10 max-w-xl">
                  CloudInfra IT recruiters speak the language of engineering. We understand structural integrity, process safety, and the nuances of the USA regulatory framework.
                </p>
                ...
                <div className="ci-card p-8 bg-[#0b0b0b] relative overflow-hidden group">
                  ...
                  <p className="text-sm font-bold text-white mb-6 relative z-10">Why CloudInfra IT for Engineering?</p>
              ...
              >
                 <div className="relative h-80 rounded-[2.5rem] overflow-hidden group shadow-2xl">
                    <Image
                      ...
                      alt="Engineering recruitment team collaborating on a industrial placement"
                      fill
                ...
                <div className="ci-card p-10 bg-[#0d0d0d] relative overflow-hidden group">
                  <div className="absolute inset-0 ci-grid-bg opacity-[0.02] pointer-events-none" />
                  <p className="text-[10px] font-black uppercase tracking-[0.3em] text-white/20 mb-4 block relative z-10">Engineering Acquisition Node</p>
        ...
        <section className="bg-[#050505] border-t border-white/5 relative overflow-hidden">
          ...
          <div className="ci-container py-24 relative z-10 text-center lg:text-left">
            ...
            >
              <div>
                <h2 className="text-3xl lg:text-4xl font-bold text-white tracking-tight text-center lg:text-left">Initiate Industrial Acquisition.</h2>
                <p className="text-lg text-white/30 mt-4 max-w-xl font-light text-center lg:text-left">
                  Whether you are an engineer seeking a USA mandate or an industrial lead building a team — activate the protocol within 24 hours.
                </p>
              </div>
